...
:uri-pres: http://unallocatedspace.org
...
----
image::bat-tux.jpg[]
image::http://www.picgifs.com/graphics/t/tux/graphics-tux-850120.gif[align=right]
----
...
This can be modified by using the  `:imagesdir:` directive and spcifiying the desired relative path.
