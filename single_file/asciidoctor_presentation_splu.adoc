...
:uri-splu: https://usergroups.splunk.com/group/baltimore-splunk-user-group.html
...
Presented to {uri-splu}[Baltimore Splunk User Group] on {date}
endif::[]
...
* What is Asciidoctor?
* Writing Tools
* Getting Started Tips and Tricks for Asciidoc
...
[%step]
** Atom (with https://atom.io/packages/asciidoc-assistant[Asciidoc Assistant] package)
** Vim
** Emacs
** Sublime
** Notepad++
...
[source,asciidoc]
----
image::asciidoctor_presentation_splu-26aa6.png[]
----

<<<<

The `screenshot` attribute can be used when the `asciidoctorj-screenshot` extension is used.
...
<3> Calculating the bill for my fruit purchase
...
* https://github.com/chuckf/intro_asciidoc Chuck's Slides and Source

.Chuck's Introduction to Asciidoc(tor) presentation link (via rawgit)
image::chuck_github_intro.png[,150]
